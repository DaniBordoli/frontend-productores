...
import CheckOutCircle from '../assets/CheckOutCircle.svg';
...
export const ActiveTripCard = ({ trip, enCursoCount, finalizadoCount }) => (
  <div className="rounded-[16px] overflow-hidden shadow-sm border border-[#E8E8E8]">
    {/* Gradient header */}
    <div className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-[#37784C] to-[#5F9C73]">
      <span className="flex items-center gap-1.5 text-sm font-medium text-white">
        <img src={Clock} alt="" className="w-5 h-5 shrink-0 brightness-0 invert" />
        {enCursoCount} en curso
      </span>
      <span className="text-white/60">/</span>
      <span className="flex items-center gap-1.5 text-sm font-medium text-white">
        <img src={CheckOutCircle} alt="" className="w-5 h-5 shrink-0" />
